...
echo "=========================================="
echo "  EXPERIMENTO: LEAST_LOADED - Alta Carga"
echo "=========================================="
...
echo ""
echo "[1/8] Editando AdaptiveScheduler.java para LEAST_LOADED..."
cd scheduler
...
docker build -t adaptive-scheduler:leastloaded . -q

echo ""
echo "[4/8] Cargando imagen en Minikube..."
minikube image load adaptive-scheduler:leastloaded

echo ""
echo "[5/8] Desplegando scheduler..."
kubectl set image deployment/adaptive-scheduler -n kube-system \
  adaptive-scheduler=adaptive-scheduler:leastloaded
...
echo ""
echo "Verificando scheduler usa LEAST_LOADED:"
kubectl logs -n kube-system -l app=adaptive-scheduler --tail=5 | grep -i "strategy\|least"
...
========================================
EXPERIMENTO: LEAST_LOADED - Alta Carga
========================================
...
echo ""
echo "=========================================="
echo "  EXPERIMENTO LEAST_LOADED COMPLETADO"
echo "=========================================="
echo ""
