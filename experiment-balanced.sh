...
echo "=========================================="
echo "  EXPERIMENTO: BALANCED - Alta Carga"
echo "=========================================="
...
echo ""
echo "[1/8] Editando AdaptiveScheduler.java para BALANCED..."
cd scheduler
...
docker build -t adaptive-scheduler:balanced . -q

echo ""
echo "[4/8] Cargando imagen en Minikube..."
minikube image load adaptive-scheduler:balanced

echo ""
echo "[5/8] Desplegando scheduler..."
kubectl set image deployment/adaptive-scheduler -n kube-system \
  adaptive-scheduler=adaptive-scheduler:balanced
...
echo ""
echo "Verificando scheduler usa BALANCED:"
kubectl logs -n kube-system -l app=adaptive-scheduler --tail=5 | grep -i "strategy\|balanced"
...
========================================
EXPERIMENTO: BALANCED - Alta Carga
========================================
...
echo ""
echo "=========================================="
echo "  EXPERIMENTO BALANCED COMPLETADO"
echo "=========================================="
echo ""
